...
spurious signal. D4 thus functions as a sanity check that all models pass; the
CFL advantage is concentrated in D3.
...
Centralised Oracle (0.9824) while outperforming global FedAvg (0.9685) by 1.42
AUC points overall --- +2.65 on IL and +0.36 on SNF (Mann-Whitney U$=$400,
$p<0.001$). The XAI Audit Scorecard, computed from real SHAP values, shows that
