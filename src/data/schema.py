...
NON_IID_SPEC: Dict[str, Dict] = {
    "MC": {
        ...
        "fall_risk_score":       {"mean": 7.2,  "std": 1.5,  "clip": (2, 10)},
        "pain_assessment_score": {"mean": 5.5,  "std": 1.8,  "clip": (0, 10)},
        "resident_census":       {"mean": 60,   "std": 15,   "clip": (20, 100)},
    ...
    "SNF": {
        ...
        "fall_risk_score":       {"mean": 6.0,  "std": 1.8,  "clip": (1, 10)},
        "pain_assessment_score": {"mean": 5.0,  "std": 2.0,  "clip": (0, 10)},
        "resident_census":       {"mean": 90,   "std": 20,   "clip": (40, 120)},
    ...
    "IL": {
        ...
        # CMS benchmark: IL LPN hours ~0.3-0.5/resident/day (vs SNF ~2.0, MC ~1.8)
        "adl_cognition":         {"mean": 1.0,  "std": 0.8,  "clip": (0, 4)},
        "adl_mobility":          {"mean": 1.2,  "std": 0.9,  "clip": (0, 4)},
        "adl_eating":            {"mean": 1.0,  "std": 0.8,  "clip": (0, 3)},
        "adl_toileting":         {"mean": 1.0,  "std": 0.8,  "clip": (0, 3)},
        "medication_count":      {"mean": 5,    "std": 2.0,  "clip": (0, 12)},
        "nursing_hours_rn":      {"mean": 1.0,  "std": 0.3,  "clip": (0.2, 3)},
        "nursing_hours_lpn":     {"mean": 0.4,  "std": 0.15, "clip": (0.0, 1.5)},
        "nursing_hours_cna":     {"mean": 1.5,  "std": 0.5,  "clip": (0.3, 4)},
        "fall_risk_score":       {"mean": 2.5,  "std": 1.2,  "clip": (0, 6)},
